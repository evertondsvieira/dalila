...
describe('createDialog', () => {
  ...
  it('should create a dialog with default options', async () => {
    const { createDialog } = await import('../packages/dalila-ui/dist/dialog/index.js');
...
describe('createDrawer', () => {
  ...
  it('should default to right side', async () => {
    const { createDrawer } = await import('../packages/dalila-ui/dist/drawer/index.js');
...
describe('createPopover', () => {
  ...
  it('should create a popover with default options', async () => {
    const { createPopover } = await import('../packages/dalila-ui/dist/popover/index.js');
...
describe('createDropdown', () => {
  ...
  it('should toggle open state', async () => {
    const { createDropdown } = await import('../packages/dalila-ui/dist/dropdown/index.js');
...
describe('createCombobox', () => {
  ...
  it('should filter options by query', async () => {
    const { createCombobox } = await import('../packages/dalila-ui/dist/combobox/index.js');
...
describe('createAccordion', () => {
  ...
  it('should toggle items', async () => {
    const { createAccordion } = await import('../packages/dalila-ui/dist/accordion/index.js');
...
describe('createTabs', () => {
  ...
  it('should manage active tab', async () => {
    const { createTabs } = await import('../packages/dalila-ui/dist/tabs/index.js');
...
describe('createCalendar', () => {
  ...
  it('should initialize with current date', async () => {
    const { createCalendar } = await import('../packages/dalila-ui/dist/calendar/index.js');
...
describe('createToast', () => {
  ...
  it('should show and dismiss toasts', async () => {
    const { createToast } = await import('../packages/dalila-ui/dist/toast/index.js');
...
describe('createDropzone', () => {
  ...
  it('should track dragging state', async () => {
    const { createDropzone } = await import('../packages/dalila-ui/dist/dropzone/index.js');
...
describe('tabBindings', () => {
  ...
  it('should provide reactive bindings', async () => {
    const { createTabs, tabBindings } = await import('../packages/dalila-ui/dist/tabs/index.js');
