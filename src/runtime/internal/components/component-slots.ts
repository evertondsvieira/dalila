export function extractSlots(
  el: Element
): { defaultSlot: DocumentFragment; namedSlots: Map<string, DocumentFragment> } {
...
export function bindSlotFragments(
  defaultSlot: DocumentFragment,
  namedSlots: Map<string, DocumentFragment>,
  ...
  bindFragmentRoot: (
    ...
    options: { events: string[]; _skipLifecycle: true; _internal: true }
  ) => (() => void)
): void {
