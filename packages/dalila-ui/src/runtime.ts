import { computed, signal, type Signal } from "dalila/core/signal";
import { createScope, withScope } from "dalila/core/scope";
import { bind, type BindContext, type BindOptions } from "dalila/runtime/bind";
